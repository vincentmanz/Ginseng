...
```{r VCF to GDS, message=FALSE, warning=FALSE, cache=TRUE, class.output="scroll-100"}
...
```{r PC-AiR, message=FALSE, warning=FALSE, cache=TRUE, class.output="scroll-100"}
...
```{r message=FALSE, warning=FALSE, include=FALSE, cache=TRUE, layout="l-body-outset"}
plot_pair <- pairsplot(p)
plot_pair
```
...
## Corelation plot
```{r cor plot, message=FALSE, warning=FALSE, include=FALSE, cache=TRUE, layout="l-body-outset"}
pl <- eigencorplot(
  p,
